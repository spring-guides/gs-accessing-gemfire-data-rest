...
This guide walks you through the process of creating an application that accesses {apache-geode-name} data through a
...
https://geode.apache.org/[{apache-geode-name}] In-Memory Data Grid using Spring Data REST.
Spring Data REST takes the features of http://projects.spring.io/spring-hateoas[Spring HATEOAS]
and http://projects.spring.io/spring-data-geode[Spring Data for {apache-geode-name}] and combines them together
automatically.
