...
https://pivotal.io/big-data/pivotal-gemfire[Pivotal GemFire] In-Memory Data Grid using Spring Data REST.
Spring Data REST takes the features of https://projects.spring.io/spring-hateoas[Spring HATEOAS]
and https://projects.spring.io/spring-data-gemfire[Spring Data for Pivotal GemFire] and combines them together
automatically.
